...
void RegionconvolutionLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      ...
      if (this->blobs_.size() > 0) {
        ...
        this->blobs_[0].reset(new Blob<Dtype>(
            output_patch_w_ * output_patch_h_ * num_output_,input_channels_/ group_, input_patch_h_, input_patch_w_));
...
void RegionconvolutionLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      ...
      M_ = num_output_ * output_patch_h_ * output_patch_w_ / group_; 
